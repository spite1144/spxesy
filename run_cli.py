#!/usr/bin/env python3
"""
PROXY SCANNER v6.0 — Fetch Only Edition
...
DEFAULT_FEEDS = {
        ...
        "Rooster HTTP": "https://raw.githubusercontent.com/roosterkid/openproxylist/main/HTTPS_RAW.txt",
...
def main():
    ...
    parser = argparse.ArgumentParser(description="PROXY SCANNER v6.0 (Fetch Only Edition)")
    ...
    parser.add_argument("-w", "--threads", type=int, default=2000, help="Max worker threads (default: 2000)")
